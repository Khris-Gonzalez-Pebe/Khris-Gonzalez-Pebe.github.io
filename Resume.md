...
- Honors: Obama-Chesky Voyager ’26 · U.S. Critical Language Scholar For Arabic Finalist ’25 · Meridian-Cox Foreign Service Fellow ’24 · USGIF Scholar ’24  
...
*Geodata for Human Rights Winter School, Scholar* — Remote sensing, open-source investigations, and human rights documentation
...
## 📑 Research Projects
- **Temporal NDVI Profiling of Afghan Fields (2019–2024)** – Sentinel-2 detection of poppy cultivation; StoryMap & policy brief.  
- **Latin America Drug Seizures (2011–2024)** – R models on transport-mode effects, enforcement rhythms.  
- **Maharashtra Water Vulnerability** – Multi-hazard overlays; district-level index; 40-page report + dashboard.  
- **Punggye-ri Nuclear Test Site NDVI** – MODIS/Landsat analysis of vegetation decline post-tests.  
- **Political Capital & Advocacy in SE Asia** – R scripts modeling advocacy success across Vietnam & Indonesia.  
- **Antenatal Care & Low Birth Weight (SSA)** – Stata logit/LPM models using DHS data.  
